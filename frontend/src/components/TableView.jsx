...
function exportToExcel(cities) {
  const rows = cities.map(c => ({
    ...
    'Mayor Work Email': c.mayor_work_email || '',
    'Mayor Work Phone': c.mayor_work_phone || '',
    'Mayor Personal Email': c.mayor_personal_email || '',
    'Mayor Personal Phone': c.mayor_personal_phone || '',
    'Mayor Instagram': c.mayor_instagram || '',
    'Mayor Facebook': c.mayor_facebook || '',
