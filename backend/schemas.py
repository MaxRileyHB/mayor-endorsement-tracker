...
class CityBase(BaseModel):
    ...
    mayor_instagram_source: Optional[str] = None
    mayor_facebook: Optional[str] = None
    mayor_facebook_source: Optional[str] = None
    mayor_other_social_platform: Optional[str] = None
    mayor_other_social_handle: Optional[str] = None
    mayor_other_social_source: Optional[str] = None
    contact_scrape_status: Optional[str] = None
    contact_scrape_date: Optional[datetime] = None
    contact_scrape_log: Optional[str] = None
