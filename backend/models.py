...
class City(Base):
    ...
    mayor_work_email_source = Column(String(500))
    mayor_work_email_invalid = Column(Boolean, default=False)
    mayor_work_phone = Column(String(50))
    mayor_work_phone_source = Column(String(500))
    mayor_personal_email = Column(String(255))
    mayor_personal_email_source = Column(String(500))
    mayor_personal_email_invalid = Column(Boolean, default=False)
    mayor_personal_phone = Column(String(50))
    mayor_personal_phone_source = Column(String(500))
    mayor_instagram = Column(String(255))
    mayor_instagram_source = Column(String(500))
    mayor_facebook = Column(String(500))
    mayor_facebook_source = Column(String(500))
    mayor_other_social_platform = Column(String(100))
    mayor_other_social_handle = Column(String(255))
    mayor_other_social_source = Column(String(500))
    contact_scrape_status = Column(String(50), default='not_scraped')
    contact_scrape_date = Column(DateTime)
    contact_scrape_log = Column(Text)
